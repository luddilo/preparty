...
const Chat = ({ triggerEvent, showContent }) => {
    ...
    const addMessagesToLog = (messages: { text: string, richContent: boolean, customEvent: string, fromUser: boolean }[]) => {        
    ...
    const handleSubmit = async (e) => {
        ...
        addMessagesToLog([{ text: userMessage, richContent: false, customEvent: null, fromUser: true }])
