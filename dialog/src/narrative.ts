...
const bridge = [
    "like this dialog",
    "like the chat we're having now",
...
export const curious: BotTurn = {
    say: [
        ...
        { intent: [...Yes.examples, "hear more", "more", "I want to hear more", "tell me more", "keep telling me", "continue", "the first"], bot: ["Awesome", "Sweet", "Great"] },
        {
            intent: ["Look at projects", "Show me projects", "the latter", "the second", "show the work", "work", "the projects you have done"], bot: {
...
const founder: BotTurn = {
    say: [
        "What would you call yourself, a founder? An investor, maybe a recruiter?"
    ], user: [
        {
            intent: IWorkWith, bot: [
                {
...
const projects: BotTurn = {    
    ...
    user: [
        ...
        {
            intent: [...No.examples, "not interested"], bot: {
                say: "Are you sure?",
                user: [
                    {
                        intent: Yes, bot: {
        ...
        },
        {
            intent: ANYTHING, bot: [
                {
                    cond: { repairCount: 1 },
                    say: "Not sure I got that chief. Could you rephrase please?", repair: true
                },
                {
...
const narratory: BridgeTurn = {
    label: "PROJECTS",
    say: "Our most recent project is Narratory. It's a tool to build chatbots and voice-apps. In fact, this dialog is built with it.",
    bot: {
        say: "Pretty neat, right?", user: [
            {
            ...
            {
                intent: [...No.examples, "not neat"], bot: {
...
const furhatQuery : BotTurn = {
    ...
    user: [
        { intent: [...Yes.examples, "I have"], bot: "Awesome. That makes a bot happy :-)"},
        { intent: [...No.examples, "I have not", "I don't know", "dunno"], bot: "I see. Maybe one day!"},
        { intent: ["who is that", "who is furhat", "what is is"], bot: "It is a social robot, quite spectacular"}
    ]
}

const gitex : Array<BotTurn | string> = [{
    say: "One thing we are proud to have built for Furhat is a retail assistant that handled in-store pickups and returns. It was then showcased at the big GITEX fair in Dubai"
...
export default [greeting, welcome, intro, bridge, curious, purpose, talent, founder, projects, narratory, projectExamples, furhatQuery, ...gitex, moreFurhat, tellMore, workWith, end]