...
export const Yes: Intent = {
  examples: ["Yes", "Absolutely", "Of course", "Yep", "Okay", "Yeah", "Yeh", "Totally", "Definitely"]
}

export const No: Intent = {
  examples: ["No", "nope", "Noes", "Never", "Nah", "Totally not", "Absolutely not", "Definitely not"]
}
...
export const GoodAtSales: Intent = {
  examples: ["You are good at sales", "You seem to know it well"]
}

export const Bad: Intent = {
  examples: ["Terrible", "Bad", "Could do better", "Not good", "really bad", "horrible"]
}
...
export const IWorkWith: Intent = {
  ...
  examples: ["I work in _job", "I work as _job", "_job", "my job is _job", "I am a _job"]
}
